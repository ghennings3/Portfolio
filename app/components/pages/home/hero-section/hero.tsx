...
const MOCK_CONTACTS = [
    {
        url: 'https://github.com/ghennings3',
        icon: <IoLogoGithub />
    },
    {
        url: 'https://br.linkedin.com/in/gustavohennings',
        icon: <IoLogoLinkedin />
    }
]
    ...
    return(
        <section className="w-full lg:h-[775px] bg-hero-image bg-cover bg-center bg-no-repeat flex flex-col justify-end pb-10 sm:pb-32 py-32 lg:pb-[110px]">
            <div className="container flex items-start justify-between flex-col-reverse lg:flex-row">
                ...
                <div>
                    <Image width={420} height={404} src={'/images.profile-pic.png'} alt="Profile pic" className="w-[300px] h-[300px] lg:w-[420px] lg:h-[404px] mb-6 lg:mb-0 shadow-2xl rounded-lg object-cover"/>
                </div>
            </div>
        </section>
    )
